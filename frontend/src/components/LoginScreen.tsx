...
export function LoginScreen() {
  ...
  const form = useForm({
    ...
    validate: {
      username: (value) =>
        isSignup && value.length === 0 ? "Username is required" : null,
      ...
      agreeToPrivacy: (value) =>
        isSignup && !value ? "You must agree to the Privacy Policy" : null,
    },
  });
      ...
      <Container size={420} style={{ position: "relative", zIndex: 1 }}>
        <Stack align="center" gap="md" mb="xl">
          ...
          <Text c="dimmed" ta="center" size="sm" maw={360}>
            Sign in to catalog PMG-certified banknotes and share your paper
            money collection.
          </Text>
        </Stack>
          ...
          <form onSubmit={form.onSubmit(handleSubmit)}>
            <Stack>
              ...
              <PasswordInput
                ...
                required
                description={
                  isSignup ? "Must be at least 8 characters" : undefined
                }
